...
def test_smote_model(test_data_processed, test_labels):
    ...
    smote_model = load('src/models/serialized/smote_model_logistic_regression.pkl')
    ...
    disp.plot()
    plt.savefig('reports/figures/testing/smote_test_log_reg_confusion_matrix.png')  # Save the plot as a file
    plt.close()  # Close the plot to free up memory

    return metrics_dict

def test_smote_rf_model(test_data_processed, test_labels):
    # Load the smote model
    smote_model = load('src/models/serialized/smote_model_rf.pkl')
    ...
    disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=smote_model.classes_)
    disp.plot()
    plt.savefig('reports/figures/testing/smote_test_rf_confusion_matrix.png')  # Save the plot as a file
    plt.close()  # Close the plot to free up memory

    return metrics_dict


def test_smote_xgb_model(test_data_processed, test_labels):
    # Load the smote model
    smote_model = load('src/models/serialized/smote_model_xgb_regression.pkl')
    ...
    disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=smote_model.classes_)
    disp.plot()
    plt.savefig('reports/figures/testing/smote_test_xgb_confusion_matrix.png')  # Save the plot as a file
    plt.close()  # Close the plot to free up memory
...
if __name__ == '__main__':
    ...
    smote_test_results = test_smote_xgb_model(test_data_processed, test_labels)
